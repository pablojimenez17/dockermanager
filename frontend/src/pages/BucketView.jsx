...
const BucketView = ({ bucketName, onClose }) => {
                    ...
                    <div className="flex items-center space-x-3 truncate pr-4">
                        ...
                        <div className="truncate">
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400 flex items-center gap-1">
                                MinIO Secure Bucket Object Storage
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <div className="flex-1 overflow-y-auto bg-slate-50/50 dark:bg-slate-900/50 p-6">
                    {loading && objects.length === 0 ? (
                        ...
                        <div className="text-center py-24">
                            ...
                            <h3 className="text-lg font-medium text-slate-700 dark:text-slate-200">Bucket is empty</h3>
                            ...
                            <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                                <thead className="bg-slate-50 dark:bg-slate-800/80">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider hidden sm:table-cell">Size</th>
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider hidden md:table-cell">Modified</th>
