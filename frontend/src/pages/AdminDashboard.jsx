...
const AdminDashboard = () => {
    ...
    if (loading) return <div className="p-8 text-slate-900 dark:text-white">Loading admin resources...</div>;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 rounded-3xl shadow-lg relative overflow-hidden group col-span-1">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-purple-600 dark:text-purple-400 font-medium mb-1">Total Users</h3>
