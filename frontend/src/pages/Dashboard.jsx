    ...
    return (
        <div className="p-4 md:p-8 pb-20 text-slate-900 dark:text-white transition-colors duration-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:scale-110 transition-transform duration-500">
                        <Server size={64} />
                    </div>
                    <div className="relative z-10">
                        <h3 className="text-slate-600 dark:text-slate-300 font-medium mb-1">Total Containers</h3>
                ...
                <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-slate-600 dark:text-slate-300 font-medium mb-1">Running</h3>
                        <div className="text-5xl font-bold text-emerald-600 dark:text-emerald-400 flex items-center space-x-3">
                ...
                <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-slate-600 dark:text-slate-300 font-medium mb-1">Stopped / Error</h3>
                        <div className="text-5xl font-bold text-rose-600 dark:text-rose-400 flex items-center space-x-3">
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Link to="/app/create" className="p-6 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl hover:bg-white dark:hover:bg-slate-800 hover:-translate-y-1 hover:shadow-lg hover:shadow-brand-500/10 hover:border-brand-500/50 transition-all duration-300 group flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-slate-600 dark:text-slate-300">Launch a predefined template or custom image</p>
                        </div>
                        <div className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center group-hover:bg-brand-500 group-hover:text-white group-hover:border-brand-500 transition-colors text-slate-400 dark:text-slate-500">
                            <span className="text-xl">+</span>
                        </div>
                    </Link>

                    <Link to="/app/containers" className="p-6 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl hover:bg-white dark:hover:bg-slate-800 hover:-translate-y-1 hover:shadow-lg hover:shadow-brand-500/10 hover:border-brand-500/50 transition-all duration-300 group flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-slate-600 dark:text-slate-300">View logs, stop, or remove your deployment</p>
                        </div>
                        <div className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center group-hover:bg-brand-500 group-hover:text-white group-hover:border-brand-500 transition-colors text-slate-400 dark:text-slate-500">
                            <ArrowRight size={20} />
                        </div>
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none mt-8">
                <div className="flex items-center space-x-4 mb-6">
